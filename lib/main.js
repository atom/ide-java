...
class JavaLanguageServer extends AutoLanguageClient {
  ...
  installServer (serverHome) {
    ...
    return DownloadFile(serverDownloadUrl, localFileName, (bytesDone, percent) => this.updateStatusBar(`Downloading ${percent}%`), serverDownloadSize)
      ...
      .then(() => this.deleteFileIfExists(localFileName))
