...
const AutoImportActionProvider = require('./providers/autoImportActionProvider')

const serverDownloadUrl = 'http://download.eclipse.org/jdtls/milestones/0.7.0/jdt-language-server-0.7.0-201711020443.tar.gz'
const serverDownloadSize = 42466825
...
class JavaLanguageClient extends AutoLanguageClient {
  ...
  provideCodeActions() { return AutoImportActionProvider(this) }
