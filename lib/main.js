...
const serverDownloadUrl = 'https://download.jboss.org/jbosstools/jdt.ls/staging/jdt-language-server-0.1.0-201704180126.tar.gz'
const serverDownloadSize = 40873858
...
class JavaLanguageClient extends AutoLanguageClient {
  ...
  getJavaPath () {
    return (new Array(
      atom.config.get('ide-java.java.home'),
